...
console.log("The " + itemDescription + " was originally $" + originalPrice + " but after a " + discountPercentage +
    "% discount, it is now $" + withoutTax + " without tax, and $" + withTax + " with tax."); // assigned variables an output
